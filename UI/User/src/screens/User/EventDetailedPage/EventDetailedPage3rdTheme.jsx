...
const EventDetailedPage3rdTheme = () => {
  ...
  return (
    <div
      ...
      className="max-h-[calc(100vh-90px)] overflow-y-scroll overflow-x-hidden bg-cover bg-no-repeat bg-center"
    >
            ...
            <div className="">
              ...
              <div className="flex flex-row justify-between h-14 items-center max-sm:text-sm">
                <div className="flex items-center gap-3">
                  <BsCalendar2Week className="text-2xl max-sm:text-base" />{" "}
